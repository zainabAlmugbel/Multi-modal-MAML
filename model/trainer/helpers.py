...
def get_dataloader(args):
    if args.dataset == 'MiniImageNet':
        ...
        from model.dataloader.slake import Slake as Dataset    
        args.dropblock_size = 2       
    elif args.dataset == 'Flower':
        from model.dataloader.flower import Flower as Dataset    
        args.dropblock_size = 2       
    else:
...
def backbone_sentence_embedding(full_data, encoder, fusion_method):
    """
    ...
    for data in full_data: # for each shot
        # (5, 800)
        encoded_result = encoder(data, fusion_method) # 75 sentence * 384
    ...
    #print(last_layer_data, last_layer_data.shape) # 4 *640
