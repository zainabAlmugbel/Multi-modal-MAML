...
def postprocess_args(args):
    save_path1 = '-'.join([args.dataset, args.model_class, args.backbone_class, args.text_encoder,'3', '{:02d}w{:02d}s{:02}q'.format(args.way, args.shot, args.query)])
...
def get_command_line_parser():
    ...
    parser.add_argument('--eval_shot', type=int, default=1)#1
    parser.add_argument('--query', type=int, default=8) #8
    parser.add_argument('--eval_query', type=int, default=8)#8
